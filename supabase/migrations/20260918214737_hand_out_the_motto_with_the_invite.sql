...
-- motto muss also hinein, sonst sieht ein ausgeloggter Besucher das Motto nie.
--
-- Drei Dinge an dieser Migration sind heikel:
--
...
--    20260827113025_stop_handing_out_the_address_of_a_party_that_is_over.sql
...
--    geschrieben. Geaendert sind genau zwei Stellen: `motto text` in der returns-Liste
--    und `e.motto` im select.
...
begin
  ...
  return query
    select e.id, e.host_id, e.title, e.description, e.motto, e.event_date, e.ends_at,
           case
